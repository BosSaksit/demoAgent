...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, callapi) {
    ...
    HomePage.prototype.delete = function (id) {
        this.callapi.deleteUser(id).subscribe(function (it) {
    ...
    HomePage.prototype.getAllUser = function () {
        var _this = this;
        this.callapi.getUserAll().subscribe(function (it) {
            console.log(it);
            _this.getuser = it;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_callapi_callapi__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__angular_common_http__ = __webpack_require__(154);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_7__providers_callapi_callapi__["a" /* CallapiProvider */]
            ]
        })
    ], AppModule);
    return AppModule;
...
var CallapiProvider = /** @class */ (function () {
    function CallapiProvider(http) {
        this.http = http;
        console.log('Hello CallapiProvider Provider');
    }
    CallapiProvider_1 = CallapiProvider;
    CallapiProvider.prototype.getUserAll = function () {
        return this.http.get(CallapiProvider_1.host + 'User/GetAll');
    };
    CallapiProvider.prototype.addUser = function (data) {
        console.log(data);
    ...
    CallapiProvider.prototype.deleteUser = function (userId) {
        return this.http.delete(CallapiProvider_1.host + 'User/DeleteUser/' + userId);
    };
